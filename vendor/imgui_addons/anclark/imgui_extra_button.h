...
namespace ImGui
{
    ...
    IMGUI_API bool ComboButton(char const *label, float &value, char const *const names[], unsigned int nameCount, ImVec2 const &size = ImVec2(0, 0), char const *tooltip = NULL);
    ...
    IMGUI_API bool SelectorPanel(char const *label, char const *names[], float &value, const unsigned int nameCount, char const *tooltips[] = NULL, ImVec2 const &size = ImVec2(0, 0), const unsigned int tableColumn = 1);
