...
void ImguiEditor::setupImGui()
{
    ...
    // NOTICE: On Windows, I need to register my own callbacks to workaround
    //         with empty context issue.
    ...
    _setMyGLFWCallbacks();
#else // This workaround causes error on Linux
...
{
    // Request drawing process to stop renderer loop
 ...
 * It should be a global function other than a class member.
 *
